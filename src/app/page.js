...
export default function Home() {
  return (
    ...
    <div className="min-h-screen bg-[url('/flower.png')] bg-repeat bg-cover flex flex-col justify-center relative">
      ...
      <div className = "backdrop-blur-md bg-white/30 rounded-xl p-6 md:p-10 max-w-xl mx-4 mt-12 shadow-xl z-10">
        <h1 className = "text-4xl font-bold mb-4 font-serif">Hey There!</h1>
      ...
      <div className = "absolute bottom-0 right-0 w-1/2 max-w-[300px] md:max-w-[400px]">
